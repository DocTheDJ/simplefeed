...
class CreateUtil:
    ...
    def add_all_feeds(DB):
        ...
        Feeds.objects.using(DB).create(feed_link='https://www.asportpro.cz/export/categories.xml?patternId=-31&hash=b951e7b3ce1530141de71d6ed02d8b7c50ac17fbc920f4de22cf06bf033190eb', usage="c", name='Eshop-categories', source=None, master_feed=None)
